...
// File: contracts/FSwapPoolInitializable.sol

pragma solidity 0.6.12;

contract FSwapPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public FSWAP_POOL_FACTORY;
...
// File: contracts/FSwapPoolFactory.sol

pragma solidity 0.6.12;

contract FSwapPoolFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(FSwapPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        FSwapPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewFSwapPoolContract(smartChefAddress);
    }
}
